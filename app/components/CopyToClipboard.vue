<template>
  <div>
    ...
    <div v-show="showToast" :class="['flex items-center fixed z-50 ', toastPosition, toastTextColor, 'px-4 py-2 rounded-md shadow-md  bg-white dark:bg-gray-800']">
      <font-awesome-icon :icon="['fa', (success ? 'check-circle' : 'times-circle')]"></font-awesome-icon>
...
export default {
  props: {
    ...
    buttonClass: {
      type: String,
      default: 'text-blue-500 hover:text-blue-800 dark:text-blue-600 dark:hover:text-blue-200'
    }
  },
  data() {
    return {
